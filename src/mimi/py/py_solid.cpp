...
std::shared_ptr<mimi::utils::RuntimeCommunication> PySolid::RuntimeCommunication() {
    MIMI_FUNC()
...
py::array_t<int>
  PySolid::BoundaryDofIds(const std::string& fes_name, const int& bid, const int& dim) {
    MIMI_FUNC()
